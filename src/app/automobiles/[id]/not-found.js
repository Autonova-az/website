...
export default function AutomobileNotFound() {
  return (
    <>
      <Navbar locale="az" />
          ...
          <div className={styles.content}>
            ...
            <div className={styles.textSection}>
              ...
              <p className={styles.description}>
                Axtardığınız avtomobil mövcud deyil, artıq satılıb və ya ID səhvdir. Digər premium avtomobillərimizi nəzərdən keçirin.
              </p>
            </div>
