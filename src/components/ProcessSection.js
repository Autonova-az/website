...
export default function ProcessSection({ data }) {
  // Debug logging
  console.log('ProcessSection data:', data);
    ...
    <section className={styles.features}>
      <div className="container">
        ...
        <div className={styles.featuresGrid}>
          {data.map((step) => {
            const convertedIcon = convertHeroiconToFontAwesome(step.icon);
            console.log(`ProcessSection - Converting icon: ${step.icon} -> ${convertedIcon}`);
